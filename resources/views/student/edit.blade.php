                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('student.update', $student->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="{{ $student->tanggal_lahir ? \Carbon\Carbon::parse($student->tanggal_lahir)->format('d-m-Y') : '' }}" required>
                        </div>
